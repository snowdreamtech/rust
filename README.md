...
services:
  rust:
    image: snowdreamtech/rust:latest
    container_name: rust
    environment:
      - TZ=Asia/Shanghai
    restart: unless-stopped
...
docker buildx build -t snowdreamtech/rust --platform=linux/386,linux/amd64,linux/arm/v6,linux/arm/v7,linux/arm64,linux/ppc64le,linux/riscv64,linux/s390x . --push
```
